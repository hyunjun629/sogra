    ...
    <div className="min-h-screen">
      ...
      <section className="relative px-4 py-24 text-center overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-indigo-950/50 border border-indigo-700/50 rounded-full px-4 py-2 text-indigo-400 text-sm mb-6">
          ...
          <div className="flex justify-center gap-8 mb-12">
            <div className="text-center">
              <div className="text-3xl font-bold text-indigo-400">{stats.stores || 3}</div>
              <div className="text-sm text-zinc-500">등록 상점</div>
            </div>
            <div className="w-px bg-zinc-800" />
            <div className="text-center">
              <div className="text-3xl font-bold text-emerald-400">{stats.products || 5}</div>
              <div className="text-sm text-zinc-500">인증 상품</div>
            </div>
            <div className="w-px bg-zinc-800" />
            <div className="text-center">
              <div className="text-3xl font-bold text-amber-400">5종</div>
              <div className="text-sm text-zinc-500">보안 방어</div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/product/1?token=demo" className="btn-ghost text-lg py-3 px-8 text-center">
              📱 샘플 QR 페이지 보기
            </Link>
            <Link to="/admin" className="bg-zinc-800 hover:bg-zinc-700 text-zinc-200 font-semibold text-lg py-3 px-8 rounded-lg transition-colors text-center">
              🛡️ 관리자 대시보드
            </Link>
          </div>
        </div>
      ...
      <section className="px-4 py-16 max-w-6xl mx-auto">
        <h2 className="text-2xl font-bold text-center text-zinc-100 mb-12">4가지 핵심 보안 기능</h2>
      ...
      <section className="px-4 py-16 max-w-4xl mx-auto">
        <h2 className="text-2xl font-bold text-center text-zinc-100 mb-4">서비스 지역</h2>
        <p className="text-center text-zinc-500 mb-8">대전·세종·충남·충북 지역 소상공인을 위한 플랫폼</p>
      ...
      <section className="px-4 py-16 bg-zinc-900/50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-center text-zinc-100 mb-12">이용 흐름</h2>
          <div className="flex flex-col md:flex-row gap-4 items-center justify-center">
            {[
              { step: '1', role: '상인', action: '상품 등록', icon: '🏪' },
              { step: '→', role: '', action: '', icon: '' },
              { step: '2', role: '시스템', action: 'HMAC QR 자동 생성', icon: '🔐' },
              { step: '→', role: '', action: '', icon: '' },
              { step: '3', role: '고객', action: 'QR 스캔 → 검증', icon: '📱' },
              { step: '→', role: '', action: '', icon: '' },
              { step: '4', role: '관리자', action: '실시간 관제', icon: '🛡️' },
            ].map((item, i) => item.action ? (
              <div key={i} className="card text-center min-w-32">
